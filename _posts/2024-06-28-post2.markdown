...
excerpt: "In product and business, understanding drivers of growth is crucial for decision making. Two concepts that play a significant role in this analysis are contribution to growth (CTG) and mix shift. 
...
![](/assets/images/post2/img1.png){: .half-size.center }


And here’s an interview question from Meta, where a Mix Shift lens would be applicable.

![](/assets/images/post2/img2.png){: .half-size.center }
...
![](/assets/images/post2/img4.png){: .half-size.center }
...
![](/assets/images/post2/img5.png){: .half-size.center }
