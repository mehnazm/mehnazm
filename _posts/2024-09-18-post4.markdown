...
![](/assets/images/post4/img0.png){: .center }
...
![](/assets/images/post4/img1.png){: .center }
...
![](/assets/images/post4/img2.png){: .center }
...
![](/assets/images/post4/img6.png){: .center }
...
1. Sample Size: There must be a large number of samples. A common rule of thumb is that 30 samples are often sufficient for the LLN and CLT to apply. However, in the case of fat-tailed distributions like the 80/20 Pareto distribution, it can take about [1014 samples for the LLN to take effect, and the CLT may not apply at all](https://www.youtube.com/watch?v=nDY_fh2TVlI).
...
![](/assets/images/post4/img7.png){: .center }
...
![](/assets/images/post4/img8.png){: .center }
